...
require (
	...
	// Floor, not a preference: v1.2.7 carries cosmos/iavl#1142, the fast-node
	// cache/commit race that gave a query-serving node a stale read of a deleted
	// key and a LastResultsHash split (incident 2026-09). app/arch_deps_test.go
	// enforces it.
