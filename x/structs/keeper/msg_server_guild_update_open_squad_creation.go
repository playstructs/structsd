...
func (k msgServer) GuildUpdateOpenSquadCreation(goCtx context.Context, msg *types.MsgGuildUpdateOpenSquadCreation) (*types.MsgGuildUpdateResponse, error) {
    ...
    if (msg.OpenSquadCreation != guild.OpenSquadCreation) {
        guild.SetOpenSquadCreation(msg.OpenSquadCreation)
