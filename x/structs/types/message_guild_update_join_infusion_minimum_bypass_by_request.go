...
func NewMsgGuildUpdateJoinInfusionMinimumBypassByRequest(creator string, guildId string, guildJoinBypassLevel GuildJoinBypassLevel) *MsgGuildUpdateJoinInfusionMinimumBypassByRequest {
