...
func NewMsgGuildUpdateJoinInfusionMinimumBypassByRequest(creator string, id uint64, guildJoinBypassLevel uint64) *MsgGuildUpdateJoinInfusionMinimumBypassByRequest {
