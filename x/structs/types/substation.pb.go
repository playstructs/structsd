...
func (m *Substation) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *Substation) GetPfp() string {
	if m != nil {
		return m.Pfp
	}
	return ""
...
var fileDescriptor_1dfac9318fba59fb = []byte{
	...
	0x46, 0x32, 0x48, 0xa9, 0x88, 0x8b, 0x2b, 0x18, 0x6e, 0xb8, 0x10, 0x1f, 0x17, 0x53, 0x66, 0x8a,
	...
	0x2c, 0xc9, 0x2f, 0x92, 0x60, 0x06, 0x8b, 0xc3, 0xb8, 0x42, 0x42, 0x5c, 0x2c, 0x79, 0x89, 0xb9,
	0xa9, 0x12, 0x2c, 0x60, 0x61, 0x30, 0x5b, 0x48, 0x80, 0x8b, 0xb9, 0x20, 0xad, 0x40, 0x82, 0x15,
	0x2c, 0x04, 0x62, 0x3a, 0x19, 0x9e, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47,
	0x72, 0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94,
	0x38, 0xcc, 0x9d, 0x15, 0x70, 0x17, 0x97, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x5d, 0x6b,
	0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x19, 0x90, 0xd1, 0x30, 0x1a, 0x01, 0x00, 0x00,
}
...
func (m *Substation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pfp) > 0 {
		i -= len(m.Pfp)
		copy(dAtA[i:], m.Pfp)
		i = encodeVarintSubstation(dAtA, i, uint64(len(m.Pfp)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintSubstation(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Creator) > 0 {
