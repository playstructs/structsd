...
var (
    ...
    ErrReactorBeginMigration                    =  sdkerrors.Register(ModuleName, 2003, "Reactor Beginning Migration Failed")
    ErrReactorCancelDefusion                    =  sdkerrors.Register(ModuleName, 2004, "Reactor Canceling Defusion Failed")
