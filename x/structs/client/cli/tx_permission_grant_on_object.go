...
func CmdPermissionGrantOnObject() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "permission-grant-on-object [objectId] [playerId] [permission,permission2,...]",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgPermissionGrantOnObject(
