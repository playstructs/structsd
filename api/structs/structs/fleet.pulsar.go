...
var (
	...
	fd_Fleet_commandStruct        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Fleet_commandStruct = md_Fleet.Fields().ByName("commandStruct")
}
...
func (x *fastReflection_Fleet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CommandStruct != "" {
		value := protoreflect.ValueOfString(x.CommandStruct)
		if !f(fd_Fleet_commandStruct, value) {
			return
		}
	}
}
...
func (x *fastReflection_Fleet) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "structs.structs.Fleet.commandStruct":
		return x.CommandStruct != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Fleet) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "structs.structs.Fleet.commandStruct":
		x.CommandStruct = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: structs.structs.Fleet"))
		}
...
func (x *fastReflection_Fleet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "structs.structs.Fleet.commandStruct":
		panic(fmt.Errorf("field commandStruct of message structs.structs.Fleet is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: structs.structs.Fleet"))
		}
...
func (x *fastReflection_Fleet) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.CommandStruct) > 0 {
			i -= len(x.CommandStruct)
			copy(dAtA[i:], x.CommandStruct)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.CommandStruct)))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 16:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field CommandStruct", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.CommandStruct = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func (x *Fleet) GetCommandStruct() string {
	if x != nil {
		return x.CommandStruct
	}
	return ""
...
var file_structs_structs_fleet_proto_rawDesc = []byte{
	...
	0x6f, 0x2f, 0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x04,
	...
	,
