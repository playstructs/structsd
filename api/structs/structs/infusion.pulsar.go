...
var (
	...
	fd_Infusion_defusing        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Infusion_defusing = md_Infusion.Fields().ByName("defusing")
}
...
func (x *fastReflection_Infusion) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Defusing != "" {
		value := protoreflect.ValueOfString(x.Defusing)
		if !f(fd_Infusion_defusing, value) {
			return
		}
	}
}
...
func (x *fastReflection_Infusion) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "structs.structs.Infusion.defusing":
		return x.Defusing != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Infusion) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "structs.structs.Infusion.ratio":
		x.Ratio = value.Uint()
	case "structs.structs.Infusion.defusing":
		x.Defusing = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: structs.structs.Infusion"))
		}
...
func (x *fastReflection_Infusion) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "structs.structs.Infusion.defusing":
		panic(fmt.Errorf("field defusing of message structs.structs.Infusion is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: structs.structs.Infusion"))
		}
...
func (x *fastReflection_Infusion) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Defusing) > 0 {
			i -= len(x.Defusing)
			copy(dAtA[i:], x.Defusing)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Defusing)))
			i--
			dAtA[i] = 0x4a
		}
		if x.Ratio != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 9:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field Defusing", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.Defusing = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type Infusion struct {
	...
	Defusing        string     `protobuf:"bytes,9,opt,name=defusing,proto3" json:"defusing,omitempty"`
}
...
func (x *Infusion) GetDefusing() string {
	if x != nil {
		return x.Defusing
	}
	return ""
...
var file_structs_structs_infusion_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x90, 0x03, 0x0a, 0x08, 0x49, 0x6e, 0x66, 0x75, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4c,
	...
	,
