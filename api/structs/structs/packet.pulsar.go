...
var (
	md_StructsPacketData        protoreflect.MessageDescriptor
	fd_StructsPacketData_noData protoreflect.FieldDescriptor
)

func init() {
	file_structs_structs_packet_proto_init()
	md_StructsPacketData = File_structs_structs_packet_proto.Messages().ByName("StructsPacketData")
	fd_StructsPacketData_noData = md_StructsPacketData.Fields().ByName("noData")
}

var _ protoreflect.Message = (*fastReflection_StructsPacketData)(nil)

type fastReflection_StructsPacketData StructsPacketData

func (x *StructsPacketData) ProtoReflect() protoreflect.Message {
	return (*fastReflection_StructsPacketData)(x)
}

func (x *StructsPacketData) slowProtoReflect() protoreflect.Message {
	mi := &file_structs_structs_packet_proto_msgTypes[0]
...
var _fastReflection_StructsPacketData_messageType fastReflection_StructsPacketData_messageType
var _ protoreflect.MessageType = fastReflection_StructsPacketData_messageType{}

type fastReflection_StructsPacketData_messageType struct{}

func (x fastReflection_StructsPacketData_messageType) Zero() protoreflect.Message {
	return (*fastReflection_StructsPacketData)(nil)
}
func (x fastReflection_StructsPacketData_messageType) New() protoreflect.Message {
	return new(fastReflection_StructsPacketData)
}
func (x fastReflection_StructsPacketData_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_StructsPacketData
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_StructsPacketData) Descriptor() protoreflect.MessageDescriptor {
	return md_StructsPacketData
}
...
func (x *fastReflection_StructsPacketData) Type() protoreflect.MessageType {
	return _fastReflection_StructsPacketData_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_StructsPacketData) New() protoreflect.Message {
	return new(fastReflection_StructsPacketData)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_StructsPacketData) Interface() protoreflect.ProtoMessage {
	return (*StructsPacketData)(x)
}
...
func (x *fastReflection_StructsPacketData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Packet != nil {
		switch o := x.Packet.(type) {
		case *StructsPacketData_NoData:
			v := o.NoData
			value := protoreflect.ValueOfMessage(v.ProtoReflect())
			if !f(fd_StructsPacketData_noData, value) {
				return
			}
		}
	}
...
func (x *fastReflection_StructsPacketData) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_StructsPacketData) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_StructsPacketData) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_StructsPacketData) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*StructsPacketData)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: StructsPacketData: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: StructsPacketData: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.Packet = &StructsPacketData_NoData{v}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
func init() {
	file_structs_structs_packet_proto_init()
	md_NoData = File_structs_structs_packet_proto.Messages().ByName("NoData")
}
...
func (x *NoData) slowProtoReflect() protoreflect.Message {
	mi := &file_structs_structs_packet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
type StructsPacketData struct {
	...
	//
	//	*StructsPacketData_NoData
	Packet isStructsPacketData_Packet `protobuf_oneof:"packet"`
}

func (x *StructsPacketData) Reset() {
	*x = StructsPacketData{}
...
func (x *StructsPacketData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StructsPacketData) ProtoMessage() {}

// Deprecated: Use StructsPacketData.ProtoReflect.Descriptor instead.
func (*StructsPacketData) Descriptor() ([]byte, []int) {
	return file_structs_structs_packet_proto_rawDescGZIP(), []int{0}
}

func (x *StructsPacketData) GetPacket() isStructsPacketData_Packet {
	if x != nil {
		return x.Packet
	}
	return nil
...
func (x *StructsPacketData) GetNoData() *NoData {
	if x, ok := x.GetPacket().(*StructsPacketData_NoData); ok {
		return x.NoData
	}
	return nil
}

type isStructsPacketData_Packet interface {
	isStructsPacketData_Packet()
}

type StructsPacketData_NoData struct {
	NoData *NoData `protobuf:"bytes,1,opt,name=noData,proto3,oneof"`
}

func (*StructsPacketData_NoData) isStructsPacketData_Packet() {}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return file_structs_structs_packet_proto_rawDescGZIP(), []int{1}
}

var File_structs_structs_packet_proto protoreflect.FileDescriptor
...
var (
	file_structs_structs_packet_proto_rawDescOnce sync.Once
	file_structs_structs_packet_proto_rawDescData = file_structs_structs_packet_proto_rawDesc
)

func file_structs_structs_packet_proto_rawDescGZIP() []byte {
	file_structs_structs_packet_proto_rawDescOnce.Do(func() {
		file_structs_structs_packet_proto_rawDescData = protoimpl.X.CompressGZIP(file_structs_structs_packet_proto_rawDescData)
	})
	return file_structs_structs_packet_proto_rawDescData
}
...
func init() { file_structs_structs_packet_proto_init() }
func file_structs_structs_packet_proto_init() {
	if File_structs_structs_packet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_structs_structs_packet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StructsPacketData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_structs_structs_packet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoData); i {
			case 0:
				return &v.state
			case 1:
	...
	file_structs_structs_packet_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*StructsPacketData_NoData)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_structs_structs_packet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_structs_structs_packet_proto_goTypes,
		DependencyIndexes: file_structs_structs_packet_proto_depIdxs,
		MessageInfos:      file_structs_structs_packet_proto_msgTypes,
	}.Build()
	File_structs_structs_packet_proto = out.File
	file_structs_structs_packet_proto_rawDesc = nil
	file_structs_structs_packet_proto_goTypes = nil
	file_structs_structs_packet_proto_depIdxs = nil
}
