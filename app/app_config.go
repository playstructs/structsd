...
import (
	...
	structsmodulev1 "structs/api/structs/structs/module"
	_ "structs/x/structs/module" // import for side-effects
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			*/
			...
			{
				Name:   structsmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&structsmodulev1.Module{}),
			},
